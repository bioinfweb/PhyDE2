...
import info.bioinfweb.phyde2.document.undo.edit.GenerateConsensusSequenceEdit;
import info.bioinfweb.phyde2.gui.MainFrame;
import info.bioinfweb.phyde2.gui.actions.AbstractPhyDEAction;

public class GenerateConsensusSequenceAction extends AbstractPhyDEAction implements Action  {
	public GenerateConsensusSequenceAction(MainFrame mainframe) {
		super(mainframe);
		putValue(Action.NAME, "Generate consensus sequence"); 
	}
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		getMainFrame().getActiveAlignment().executeEdit(new GenerateConsensusSequenceEdit(contigSequences));	
	}
