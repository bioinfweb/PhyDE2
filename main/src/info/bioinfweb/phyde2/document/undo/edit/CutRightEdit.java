...
public class CutRightEdit extends AlignmentEdit{
	...
	public CutRightEdit(PhyDE2AlignmentModel alignment, String sequenceIDs, int newBaseCallCutPos, int oldBaseCallCutPosition) {
		super(alignment);
	...
	//only a second click on "undo" undoes the set of a cut-position in the PherogramAreaModel. (See also: CutLeftEdit)
	//Redo does not work properly as well, because a new edit is generated during redo which leads to truncation of the
	//current redo list.

	@Override
	public void redo() throws CannotRedoException {
		pherogramModel.setRightCutPosition(newBaseCallCutPos);
		super.redo();
	}

	@Override
	public void undo() throws CannotUndoException {
		pherogramModel.setRightCutPosition(oldBaseCallCutPosition);
		super.undo();
	}
